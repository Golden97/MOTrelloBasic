...
public class OurDataBase extends SQLiteOpenHelper {
    ...
    public Cursor getTTfromDB() {
        String[] col = {DataBaseManager.DataEntry.NAME};

        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cur = db.query(DataBaseManager.DataEntry.TASKTABLES, col, null, null, null, null, null );
        return cur;
    }

    public Cursor getTLfromDB() {
        String[] col = {DataBaseManager.DataEntry.NAME};

        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cur = db.query(DataBaseManager.DataEntry.TASKLISTS, col, null, null, null, null, null );
        return cur;
    }

    public Cursor getTfromDB() {
        String[] col = {DataBaseManager.DataEntry.NAME};

        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cur = db.query(DataBaseManager.DataEntry.TASKS, col, null, null, null, null, null );
        return cur;
    }
